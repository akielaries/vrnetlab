...
class VJUNOSEVOLVED_vm(vrnetlab.VM):
    def __init__(self, hostname, username, password, conn_mode):
        ...
        self.qemu_args.extend(["-uuid", "42e911e7-850a-4744-974d-c7f1299e0905"])
    ...
    def bootstrap_config(self):
        ...
        self.wait_write("cli", "#") #TODO: when this is ran,
        ...
        self.wait_write(self.password, "New password:")
        self.wait_write(self.password, "Retype new password:")
        # set interface re0:mgmt-0 on dedicated management vrf, to avoid 
        # 10.0.0.0/24 to overlap with any "testing" network
        self.wait_write("set interfaces re0:mgmt-0 unit 0 family inet address 10.0.0.15/24", "#")
